...
crearArchivoJSON("configuracion", $informacionBD, $rutaArchivo);


//Usuarios
$usuario1 = [
    "nombre" => "cova",
    "correo" => "covadongaba@outlook.com"

];
crearArchivoJSON("usuarios", $usuario1, $rutaArchivo);

$usuario2 = [
    "nombre" => "Alex",
    "correo" => "alex@outlook.com"

];
crearArchivoJSON("usuarios", $usuario2, $rutaArchivo);
