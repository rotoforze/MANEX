                    ...
                    <div>
                        <div className='password-group'>
                            ...
                            <button className="eye-password-button" type='button'
                                id="password-addon" role='option' onClick={() => { setPasswordShown(!passwordShown) }}>
                                {
                                    passwordShown ?
                                        (
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" className="bi bi-eye" viewBox="0 0 16 16">
                                        ...
                                        (
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" className="bi bi-eye-slash" viewBox="0 0 16 16">
